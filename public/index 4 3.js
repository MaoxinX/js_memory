...
function gameSetup(data) {
    ...
    ***************************/
    ...
    svgContainer.append('text')
        .attr('text-anchor', 'middle')
        .attr('x', screen_width - screen_width / 9)
        .attr('y', screen_height / 18 + 50)
        .attr('font-size', '32')
        .attr('fill', 'black')
        .attr('id', 'total')
        .attr('font-family', 'Arial')
...
function startCategory() {
    ...
    d3.timer(function(elapsed){
        timeleft = Math.max(0, timecount - Math.floor(elapsed / 1000));
    ...
    navigator.mediaDevices.getUserMedia({ audio: true })
        .then(stream => {
            ...
            mediaRecorder.onstop = () => {
                ...
                uploadAudio(audioBlob);  // Call uploadAudio to upload the recorded audio
...
function uploadAudio(audioBlob) {
    ...
    // Create a reference to 'audio-recordings' folder and a unique filename
